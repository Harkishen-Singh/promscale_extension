...
BEGIN
    ...
    LOOP
        ...
        LOOP
            -- Create rollups for the pending ones.
    ...
    LOOP
        -- Refresh rollups for the entire duration.
...
$$
    ...
    BEGIN
        ...
        IF metric_type IS NULL THEN
            RAISE WARNING '[Rollup] Skipping creation of metric rollup for %. REASON: metric_type not found', metric_name;
            RETURN FALSE;
        END IF;
